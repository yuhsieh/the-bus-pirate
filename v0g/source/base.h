...
#define BP_FIRMWARE_STRING "Firmware v0g"
...
//#define BP_USE_LIN
//#define BP_USE_CAN
//#define BP_USE_HWI2C //doesn't work with 24FJ64GA002 REV 3
...
void bpDelayMS(const char delay);
void bpDelayUS(const char delay);
#endif
