...
#define MSG_ERROR_MODE_T 	"Comando non utilizzato in questa modalità\x0D\x0A"
...
#define MSG_OPT_DISPLAYMODE_T 	" 1. HEX\x0D\x0A 2. DEC\x0D\x0A 3. BIN\x0D\x0A 4. GREZZA\x0D\x0A"
...
#define MSG_OPT_AUXPIN_AUX_T 	"a/A/@ gestisce pin AUX\x0D\x0A"
#define MSG_OPT_AUXPIN_CS_T 	"a/A/@ gestisce pin CS/TMS\x0D\x0A"
#define MSG_OPT_TERMBAUD_ADJUST_T	"Regolare il terminale e premere spazio per continuare\x0D\x0A"
...
#define MSG_OPT_CKE_T 		"Fronte del clock di uscita:\x0D\x0A 1. Cambio Inattivo/Attivo\x0D\x0A 2. Cambio Attivo/Inattivo *default\x0D\x0A"
#define MSG_OPT_SMP_T 		"Fase campionamento ingresso:\x0D\x0A 1. Metà *default\x0D\x0A 2. Fine\x0D\x0A"
...
#define OUMSG_1W_BIT_WRITE_NOTE	" *il prossimo clock (^) avrò questo valore"
#define OUMSG_1W_MACRO_MENU	" 0.Macro menu"
#define OUMSG_1W_MACRO_MENU_ROM	"1WIRE ROM MACRO COMANDI (RIFERITI A PROTOCOLLO 1WIRE):\x0D\x0A 51.READ ROM (0x33) *per bus con singola rom\x0D\x0A 85.MATCH ROM (0x55) *seguito da indirizzo 64bit\x0D\x0A 204.SKIP ROM (0xCC) *seguito da comando\x0D\x0A 236.ALARM SEARCH (0xEC)\x0D\x0A 240.SEARCH ROM (0xF0)"
...
#define OUMSG_1W_MACRO_SEARCH_ROM_NOTE	"ID dispositivo disponbibile con MACRO, VEDERE (0)."
...
#define OUMSG_AUX_PWM_NOTE 		"Generatore di frequenza/PWM 1KHz-4,000KHz (beta)"
...
#define OUMSG_LCD_MACRO_MENU 		" 0.Menù delle Macro \x0D\x0A 1.LCD Reset\x0D\x0A 2.Inizializzazione LCD\x0D\x0A 3.Pulisci LCD\x0D\x0A 4.Posizione cursore ex:(4:0)\x0D\x0A 5.(deprecato)\x0D\x0A 6.Scrivi : numero dei numeri di test ex:(6:80)\x0D\x0A 7.Scrivi :numero di caratteri di test ex:(7:80)\x0D\x0A 8.Inserisci testo dalla posizionme corrente"
#define OUMSG_LCD_MACRO_INIT_DISPLAYLINES 	"Linee del display:\x0D\x0A 1. 1 \x0D\x0A 2. Multiple"
...
#define OUMSG_I2C_MACRO_MENU 	" 0.Menù delle macro\x0D\x0A 1.Indirizzo di ricerca a 7bit"
...
#define OUMSG_PS_ADC_VOLT_PROBE		"TENSIONE SULLA SONDA: "
...
#define HELP_MENUS_VMONITOR_T		"V Controllo tensioni di alimentazione"
#define HELP_MENUS_FREQCOUNT_T		"F Frequenziometro su AUX"
#define HELP_MENUS_FREQGEN_T		"G Generatore di frequenza/PWM su AUX"
...
#define HELP_SYNTAX_VPROBE_T		"D Misura di tensione sulle sonde ADC"
#define HELP_SYNTAX_START_T			"[ ({) Start (con lettura)"
#define HELP_SYNTAX_STOP_T			"] o } Stop"
#define HELP_SYNTAX_READ_T			"R o r lettura byte"
#define HELP_SYNTAX_WRITEBIN_T		"0b Scrive byte BIN"
#define HELP_SYNTAX_WRITEHEX_T		"0h o 0x Scrive byte HEX"
#define HELP_SYNTAX_WRTIEDEC_T		"0-255 Scrive byte DEC"
...
#define HELP_SYNTAX_BITPEEK_T		". Legge stato dei pin di input"
#define HELP_SYNTAX_BITCLK_T		"^ Clock tick"
#define HELP_SYNTAX_BITREAD_T		"! Leggi bit"
