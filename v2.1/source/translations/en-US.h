...
#define MSG_STATUS_OUTPUT_HIZ_T 	"Open drain outputs (H=input, L=GND)\x0D\x0A"
...
//RAW2WIRE//
#define OUMSG_R2W_MACRO_MENU	" 0.Macro menu\x0D\x0A 1.ISO7813-3 ATR\x0D\x0A 2.ISO7813-3 parse only\x0D\x0A"
//RAW3WIRE//
